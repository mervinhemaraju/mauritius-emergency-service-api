...
from app.api.v1.routes.cyclone import CycloneReport, CycloneNames
...
v1_api.add_resource(CycloneReport, "/<string:lang>/cyclone/report")
v1_api.add_resource(CycloneNames, "/<string:lang>/cyclone/names")
